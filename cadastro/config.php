...
$query_cadastro = "INSERT INTO cadastro(nome, email, senha, telefone, sexo, nascimento, cidade, estado, endereco) VALUES('$nome','$email','$senha','$telefone','$sexo','$nascimento','$cidade','$estado','$endereco')";
