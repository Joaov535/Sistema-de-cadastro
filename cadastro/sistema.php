...
<body>
    ...
    <div class="box-search">
        <input type="search" name="pesquisa" id="pesquisa" class="form-control w-25" placeholder="Pesquisar">
        ...
        <table class="table text-white table-bg">
            ...
            <tbody>
                ...
                while ($user_data = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                    <a class='btn btn-sm btn-outline-primary' href='edit.php?id=$user_data[id]'>
                    ...
                    <a class='btn btn-sm btn-outline-danger' href='delete.php?id=$user_data[id]'>
